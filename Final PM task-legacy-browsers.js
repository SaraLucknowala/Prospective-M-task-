...
async function experimentInit() {
  ...
  text_3 = new visual.TextStim({
    win: psychoJS.window,
    name: 'text_3',
    text: 'After typing your first name, click the spacebar to continue ',
    font: 'Arial',
    units: undefined, 
...
function instruction_2RoutineBegin(snapshot) {
  return async function () {
    ...
    instruction_2Components.push(textbox);
    instruction_2Components.push(text_3);
    instruction_2Components.push(key_resp_7);
...
function trainingblockRoutineBegin(snapshot) {
  return async function () {
    ...
    trainingblockComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
